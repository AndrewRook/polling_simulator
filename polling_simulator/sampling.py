...
def predefined_sample(n_sample, shuffled_electorate, max_num_attempts, *args, **kwargs):
...
def guaranteed_sample(n_sample, shuffled_electorate, max_num_attempts, *args, **kwargs):
